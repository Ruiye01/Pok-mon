package src.pas.pokemon.training;
        ...
        try
        {
            for(int gameIdx = 0; gameIdx < numTrainingGames; ++gameIdx)
            {
                ...
                for(Agent enemyAgent : enemyAgents)
                {
                    ...
                    Battle battle = BattleCreatorExclude.makeRandomTeams(2, 2, 4, rng, agent, enemyAgent);
        ...
        try
        {
            ...
            for(int gameIdx = 0; gameIdx < numEvalGames; ++gameIdx)
            {
                ...
                for(Agent enemyAgent : enemyAgents)
                {
                    ...
                    // currently this will make a random battle
                    Battle battle = BattleCreatorExclude.makeRandomTeams(6, 6, 4, rng, agent, enemyAgent);
